...
class ConfigModel {
  ...
  ConfigModel({
    ...
    _wholesaleFeatureEnabled = wholesaleFeatureEnabled; // Assign the new field
  ...
  bool? get wholesaleFeatureEnabled =>
      _wholesaleFeatureEnabled; // Add getter for the new field
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _wholesaleFeatureEnabled = '${json['is_wholesale']}'.contains('1');
