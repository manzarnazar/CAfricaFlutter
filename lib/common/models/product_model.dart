...
class Product {
  ...
  int? _wholesaleMinimumQty;
  int? _wholesaleMaximumQty;
  int? _isWholesale;
  String? _waitlistNote;
  Collaboration? _collaboration; // Add collaboration property
  ...
  Product({
    ...
    int? wholesaleMinimumQty,
    int? wholesaleMaximumQty,
    int? isWholesale,
    String? waitlistNote,
    Collaboration? collaboration, // Add collaboration parameter
  }) {
    _id = id;
    _name = name;
    ...
    _wholesaleMinimumQty = wholesaleMinimumQty;
    _wholesaleMaximumQty = wholesaleMaximumQty;
    _isWholesale = isWholesale;
    _waitlistNote = waitlistNote;
    _collaboration = collaboration; // Assign collaboration
  }
  ...
  int? get wholesaleMinimumQty => _wholesaleMinimumQty;
  int? get wholesaleMaximumQty => _wholesaleMaximumQty;
  int? get isWholesale => _isWholesale;
  String? get waitlistNote => _waitlistNote;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    _categoryDiscount = json['category_discount'] != null
        ...
        : null;
    _wholesaleMinimumQty = json['minimum_wholesale_qty'];
    _wholesaleMaximumQty = json['maximum_wholesale_qty'];
    _isWholesale = json['is_wholesale'];
    _waitlistNote = json['waitlist_note'];
    _collaboration = json['collaboration'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_activeReviews != null) {
      data['active_reviews'] = _activeReviews!.map((v) => v.toJson()).toList();
    }
    ...
    data['minimum_wholesale_qty'] = _wholesaleMinimumQty;
    data['maximum_wholesale_qty'] = _wholesaleMaximumQty;
    data['is_wholesale'] = _isWholesale;
    data['waitlist_note'] = _waitlistNote;

    if (_collaboration != null) {
      data['collaboration'] = _collaboration!.toJson();
    }
