                                                ...
                                                if (cart.cartList[cardIndex!]
                                                  ...
                                                  Provider.of<CartProvider>(
                                                      ...
                                                      .setCartQuantity(
                                                          ...
                                                          isWholesale: product
                                                              .isWholesale!,
                                                          wholesaleMaxQty: product
                                                              .wholesaleMaximumQty!,
                                                          wholesaleMinQty: product
                                                              .wholesaleMinimumQty!);
                                                } else {
                                                  if (product.isWholesale ==
                                                      1) {
                        ...
                        children: [
                          ...
                          product.isWholesale != 0
                              ? Positioned(
                                  ...
                                  right: 0,
                                  child: _wholesaleTag(
                                      product: product, tag: "wholesale"),
                                )
                              : product.collaboration != null
                                  ? Positioned(
                                      bottom: 0,
                                      right: 0,
                                      child: _wholesaleTag(
                          ...
                          if (product.variations == null ||
                            ...
                            if (isExistInCart) {
                              ...
                              Provider.of<CartProvider>(context, listen: false)
                                  .addToCart(
                                      cartModel!,
                                      product.isWholesale!.toInt(),
                                      product.wholesaleMinimumQty!.toInt());
                              // print(product.wholesaleMinimumQty);
