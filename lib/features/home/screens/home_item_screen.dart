...
class HomeItemScreen extends StatefulWidget {
  ...
  const HomeItemScreen({Key? key, this.productType, this.isFromNav = false})
      : super(key: key);
                ...
                return Consumer<ProductProvider>(
                  builder: (context, productProvider, child) {
                    ...
                    switch (widget.productType) {
                      ...
                      case ProductType.wholesaleItem:
                        productModel = productProvider.wholesaleProductModel;
                        break;

                      case ProductType.collaborationItem:
                        productModel =
                            productProvider.collaborationProductModel;
                        break;
