...
class _ProductDetailsScreenState extends State<ProductDetailsScreen>
  ...
  bool _isQtySet = false; // To track if qty has been set
        ...
        return Consumer<ProductProvider>(
          builder: (context, productProvider, child) {
            ...
            if (productProvider.product != null) {
              if (productProvider.product!.isWholesale == 1 && !_isQtySet) {
                // Show dialog when product is wholesale and quantity is not set
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  showDialog(
                    context: context,
                    builder: (BuildContext context) {
                      return AlertDialog(
                        title: Text('Waitlist Note'),
                        content: Text(
                            productProvider.product!.waitlistNote.toString()),
                        actions: <Widget>[
                          TextButton(
                            onPressed: () {
              ...
              if (productProvider.product != null && !_isQtySet) {
                cartProvider.setqty(
                  isWholesale:
                      productProvider.product!.isWholesale == 1 ? 1 : 0,
                  wholesaleMinQty:
                      productProvider.product!.wholesaleMinimumQty ?? 1,
                );
